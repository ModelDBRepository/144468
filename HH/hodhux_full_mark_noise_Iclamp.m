function [v, I_total, I_na, I_k, timetrack, Na, K, NNa, NK,computing_time]= hodhux_full_mark_noise_Iclamp(dt,T,Nanoise,Knoise,Nanum,Knum,trans,area)

% coded by Nicolaus Schmandt, n.schmandt@gmail.com,
% and Roberto F. Galán, rfgalan@case.edu, April 2011

%Hodgkin Huxley neuron in current clamp using Markov chains to represent stochasticity
