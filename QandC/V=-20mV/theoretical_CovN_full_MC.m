function [VRNa,VLNa,VRK,VLK,DNa,DK,QNa,QK,C0Na,C0K,ANa,AK,mINa,mIK,sINa,sIK] = theoretical_CovN_full_MC()
...
for i = 1:nNa
    ...
    for j = 1:nNa  
        ...
        if i~=j
            ...
            QNa(i,j) = -( NNas(j)*ANa(i,j) + NNas(i)*ANa(j,i) )*dt;   
            ...
            QNa(i,i) = ( temp2*temp1 - NNas(i)*ANa(i,i) )*dt;
...
for i = 1:nK
    ...
    for j = 1:nK
        ...
        if i~=j
            ...
            QK(i,j) = -( NKs(j)*AK(i,j) + NKs(i)*AK(j,i) )*dt;   
            ...
            QK(i,i) = ( temp2*temp1 - NKs(i)*AK(i,i) )*dt;
...
save theoretical_CovN_full_MC.mat
