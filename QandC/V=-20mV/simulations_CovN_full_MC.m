...
% gammaNa = gammaNa*10^6; %so that the current is in nA
% gammaK = gammaK*10^6; %so that the current is in nA
...
for t = 1:N-1
    ...
    while check == 0
      ...
      PNaij = [0     sum(rand(1,nNa(1)) < 3*ma*dt)    0       0      sum(rand(1,nNa(1)) < ha*dt)      0       0      0;...
               sum(rand(1,nNa(2)) < mb*dt)            0       sum(rand(1,nNa(2)) < 2*ma*dt)    0      0      sum(rand(1,nNa(2)) < ha*dt)      0      0;...
               0     sum(rand(1,nNa(3)) < 2*mb*dt)    0       sum(rand(1,nNa(3)) < ma*dt)     0       0      sum(rand(1,nNa(3)) < ha*dt)      0;...
               0     0       sum(rand(1,nNa(4)) < 3*mb*dt)    0      0       0       0      sum(rand(1,nNa(4)) < ha*dt);...
               sum(rand(1,nNa(5)) < hb*dt)    0       0       0      0       sum(rand(1,nNa(5)) < 3*ma*dt)    0      0;...
               0     sum(rand(1,nNa(6)) < hb*dt)      0       0      sum(rand(1,nNa(6)) < mb*dt)      0       sum(rand(1,nNa(6)) < 2*ma*dt)   0;...
               0     0       sum(rand(1,nNa(7)) < hb*dt)      0      0       sum(rand(1,nNa(7)) < 2*mb*dt)    0      sum(rand(1,nNa(7)) < ma*dt);...
   ...
   while check == 0
      ...
      PKij = [0      sum(rand(1,nK(1)) < 4*na*dt)    0      0      0;...
              sum(rand(1,nK(2)) < nb*dt)             0      sum(rand(1,nK(2)) < 3*na*dt)    0      0;...
              0      sum(rand(1,nK(3)) < 2*nb*dt)    0      sum(rand(1,nK(3)) < 2*na*dt)    0;...
              0      0      sum(rand(1,nK(4)) < 3*nb*dt)    0      sum(rand(1,nK(4)) < na*dt);...
...
save simulations_CovN_full_MC.mat
